...
DECLARE_PCI_FIXUP_EARLY(PCI_VENDOR_ID_HAILO, PCI_DEVICE_ID_HAILO_HAILO8, quirk_no_flr);
DECLARE_PCI_FIXUP_EARLY(PCI_VENDOR_ID_HAILO, PCI_DEVICE_ID_HAILO_HAILO10H, quirk_no_flr);
DECLARE_PCI_FIXUP_EARLY(PCI_VENDOR_ID_HAILO, PCI_DEVICE_ID_HAILO_HAILO15L, quirk_no_flr);
DECLARE_PCI_FIXUP_EARLY(PCI_VENDOR_ID_HAILO, PCI_DEVICE_ID_HAILO_MARS, quirk_no_flr);
